...
Eso genera `dist\pfSense-pkg-wgeasy-0.4.2.pkg` (verificado contra el formato
del paquete de terceros que ya funciona en este firewall). Luego:

```sh
scp dist/pfSense-pkg-wgeasy-0.4.2.pkg root@192.168.1.1:/root/
ssh root@192.168.1.1 pkg add /root/pfSense-pkg-wgeasy-0.4.2.pkg
```
